...
The dependency runs one way only: an integration may import ``opik_rigor``, and
nothing in ``opik_rigor`` may import an integration. That is what keeps the assertions,
...
module scope. Import the submodule you want::
    ...
    from opik_rigor.integrations.opik import log_sample_to_opik
